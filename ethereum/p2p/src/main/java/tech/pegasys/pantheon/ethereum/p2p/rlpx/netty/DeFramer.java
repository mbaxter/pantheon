...
import tech.pegasys.pantheon.ethereum.p2p.rlpx.exceptions.UnexpectedPeerConnectionException;
...
final class DeFramer extends ByteToMessageDecoder {
  ...
  private final Supplier<PeerInfo> ourInfo;
  ...
  DeFramer(
      ...
      final Supplier<PeerInfo> ourInfo,
      ...
      if (!hellosExchanged && message.getCode() == WireMessageCodes.HELLO) {
        ...
        final CapabilityMultiplexer capabilityMultiplexer =
            new CapabilityMultiplexer(
                subProtocols, ourInfo.get().getCapabilities(), peerInfo.getCapabilities());
