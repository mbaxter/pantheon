...
//        .hasMessage(
//            "Network permissioning needs to listen to BlockAddedEvents. Blockchain can't be
// null.");
//  }
//
//  @Test
...
//    doReturn(false)
//        .when(peerPermissions)
//        .isPermitted(eq(localNode), eq(notPermittedPeer),
...
//    final ArgumentCaptor<DiscoveryPeer> peerCapture =
// ArgumentCaptor.forClass(DiscoveryPeer.class);
