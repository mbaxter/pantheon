...
//    final PeerPermissionsBlacklist permissionsBlacklist = PeerPermissionsBlacklist.create();
//    final PeerReputationManager blacklist = new PeerReputationManager(permissionsBlacklist);
...
//    final PeerReputationManager blacklist = new PeerReputationManager();
//    final Peer peer = generatePeer();
//
//    assertThat(blacklist.contains(peer)).isFalse();
//
...
//    final Peer peer = generatePeer();
//    final PeerReputationManager blacklist = new PeerReputationManager(Collections.singleton(peer.getId()));
//
//    assertThat(blacklist.contains(peer)).isTrue();
//
//    blacklist.add(peer.getId());
...
//    final PeerReputationManager blacklist = new PeerReputationManager(2, Collections.singleton(bannedPeer.getId()));
//
...
//
//    final PeerReputationManager blacklist = new PeerReputationManager(2);
